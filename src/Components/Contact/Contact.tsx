    ...
    return (
        <div className='contact'>
            <div className="contact-col">
                ...
                <ul>
                    <li className='text-lg text-gray-600'><FontAwesomeIcon icon={faEnvelope} className='h-6 w-6 color-primary'></FontAwesomeIcon> arthuroliveiratst22@gmail.com</li>
                    <li className='text-lg text-gray-600'><FontAwesomeIcon icon={faWhatsapp} className='h-6 w-6 color-primary'></FontAwesomeIcon> 65 9 9256-5297</li>
